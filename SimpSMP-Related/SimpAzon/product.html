<html>
    ...
    <body>
        <div class="header">
            ...
            <div class="header-right">
                ...
                <a class="headeritem" id="orders" href="#"><center><span class="material-icons">&#xE158;</span></center></a>
                <a class="headeritem" id="account" onclick="checkLogin();" href="javascript:void(0);"><center><span class="material-icons">&#xE87C;</span></center></a>
                <a class="headeritem" id="debug" onclick="dmodelopen();" href="javascript:void(0);"><center><span class="material-icons">&#xEF3D;</span></center></a>
            </div>
        </div>
        <div class="info">
    ...
    <script src="js/setProductInfo.js"></script>
